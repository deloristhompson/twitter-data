                                                                                    ...
                                                                                    ["Listening to Dashboard all morning. I think today is going to be awesome. #dashboardconfessional #deskconfessional",
                                                                                      ...
                                                                                      {"alacritythief"=>
                                                                                        {"description"=>
                                                                                          ...
                                                                                          print "\n-------Username followed by description or N/A-------\n"
                                                                                          twitter_data.each do |user|
                                                                                            if user.values[0]["description"].nil?
                                                                                              puts "#{user.keys.first}: N/A "
                                                                                            else
                                                                                              puts "\n#{user.keys.first}: #{user.values[0]["description"]}"
                                                                                            end
                                                                                          end


                                                                                          print "\n-------Username followed by total number of followers-------\n"
                                                                                          twitter_data.each do |follow|
                                                                                            puts "#{follow.keys.first}: #{follow.values[0]["number of followers"]}"
                                                                                          end

                                                                                          print "\n-------Username followed by length of latest tweet-------\n"
                                                                                          twitter_data.each do |tweet|
                                                                                            puts "#{tweet.keys.first}: #{tweet.values[0]["latest tweet"].size}"
                                                                                          end
                                                                                          puts

                                                                                          launch = 0
                                                                                          twitter_data[0]["LaunchAcademy"]["last twenty tweets"].each do |odds|
                                                                                            launch += odds.size
                                                                                          end
                                                                                          puts twitter_data[0].keys
                                                                                          puts launch

                                                                                          dpickett = 0
                                                                                          twitter_data[1]["dpickett"]["last twenty tweets"].each do |odds|
                                                                                            dpickett += odds.size
                                                                                          end
                                                                                          puts twitter_data[1].keys
                                                                                          puts dpickett

                                                                                          sTWatkins78 = 0
                                                                                          twitter_data[2]["STWatkins78"]["last twenty tweets"].each do |odds|
                                                                                            sTWatkins78 += odds.size
                                                                                          end
                                                                                          puts twitter_data[2].keys
                                                                                          puts sTWatkins78

                                                                                          chrisccerami = 0
                                                                                          twitter_data[3]["chrisccerami"]["last twenty tweets"].each do |odds|
                                                                                            chrisccerami += odds.size
                                                                                          end
                                                                                          puts twitter_data[3].keys
                                                                                          puts "#{chrisccerami}"

                                                                                          spencercdixon = 0
                                                                                          twitter_data[4]["spencercdixon"]["last twenty tweets"].each do |odds|
                                                                                            spencercdixon += odds.size
                                                                                          end
                                                                                          puts twitter_data[4].keys
                                                                                          puts "#{spencercdixon}"

                                                                                          corinnebabbles = 0
                                                                                          twitter_data[5]["corinnebabbles"]["last twenty tweets"].each do |odds|
                                                                                            corinnebabbles += odds.size
                                                                                          end
                                                                                          puts twitter_data[5].keys
                                                                                          puts "#{corinnebabbles}"

                                                                                          dot_the_speck = 0
                                                                                          twitter_data[6]["dot_the_speck"]["last twenty tweets"].each do |odds|
                                                                                            dot_the_speck += odds.size
                                                                                          end
                                                                                          puts twitter_data[6].keys
                                                                                          puts "#{dot_the_speck}"

                                                                                          bostonrb = 0
                                                                                          twitter_data[7]["bostonrb"]["last twenty tweets"].each do |odds|
                                                                                            bostonrb += odds.size
                                                                                          end
                                                                                          puts twitter_data[7].keys
                                                                                          puts "#{bostonrb}"

                                                                                          judngu = 0
                                                                                          twitter_data[8]["judngu"]["last twenty tweets"].each do |odds|
                                                                                            judngu += odds.size
                                                                                          end
                                                                                          puts twitter_data[8].keys
                                                                                          puts "#{judngu}"

                                                                                          lizvdk = 0
                                                                                          twitter_data[9]["lizvdk"]["last twenty tweets"].each do |odds|
                                                                                            lizvdk += odds.size
                                                                                          end
                                                                                          puts twitter_data[9].keys
                                                                                          puts "#{lizvdk}"

                                                                                          hchood = 0
                                                                                          twitter_data[10]["hchood"]["last twenty tweets"].each do |odds|
                                                                                            hchood += odds.size
                                                                                          end
                                                                                          puts twitter_data[10].keys
                                                                                          puts "#{hchood}"

                                                                                          wand_chris = 0
                                                                                          twitter_data[11]["wand_chris"]["last twenty tweets"].each do |odds|
                                                                                            wand_chris += odds.size
                                                                                          end
                                                                                          puts twitter_data[11].keys, "#{wand_chris}"
                                                                                          # puts "#{wand_chris}"

                                                                                          julissaJM = 0
                                                                                          twitter_data[12]["julissaJM"]["last twenty tweets"].each do |odds|
                                                                                            julissaJM += odds.size
                                                                                          end
                                                                                          puts twitter_data[12].keys
                                                                                          puts "#{julissaJM}"

                                                                                          ashleytbasinger = 0
                                                                                          twitter_data[13]["ashleytbasinger"]["last twenty tweets"].each do |odds|
                                                                                            ashleytbasinger += odds.size
                                                                                          end
                                                                                          puts twitter_data[13].keys
                                                                                          puts "#{ashleytbasinger}"

                                                                                          alacritythief = 0
                                                                                          twitter_data[14]["alacritythief"]["last twenty tweets"].each do |odds|
                                                                                            alacritythief += odds.size
                                                                                          end
                                                                                          puts twitter_data[14].keys
                                                                                          puts "#{alacritythief}"

                                                                                          max = -1
                                                                                          twitter_data.each do |follow|
                                                                                            if follow.values[0]["number of followers"] > max
                                                                                              max = follow.values[0]["number of followers"]
                                                                                              puts "\n#{follow.keys.first}: has the most followers with #{max}"
                                                                                            end
                                                                                          end

                                                                                          most_friends = {}
                                                                                          max_friends = - 1
                                                                                          twitter_data.each do |friends|
                                                                                            if friends.values[0]["number of friends"] > max_friends
                                                                                              max_friends = friends.values[0]["number of friends"]
                                                                                              friends.each do |key, value|
                                                                                                most_friends = key
                                                                                              end
                                                                                            end
                                                                                          end
                                                                                          puts "Most Friends: #{most_friends} with #{max_friends}"

                                                                                          most_tweets = {}
                                                                                          max_tweet = - 1
                                                                                          twitter_data.each do |tweet|
                                                                                            if tweet.values[0]["number of tweets"] > max_tweet
                                                                                              max_tweet = tweet.values[0]["number of tweets"]
                                                                                              tweet.each do |key, value|
                                                                                                most_tweets = key
                                                                                              end
                                                                                            end
                                                                                          end
                                                                                          puts "Most Tweets: #{most_tweets} with #{max_tweet}"

                                                                                          print "\nUser that have description listed in 'twitter_data:'\n"
                                                                                          twitter_data.each do |descript|
                                                                                            if descript.values[0]["description"]
                                                                                              puts "#{descript.keys.first} "
                                                                                            end
                                                                                          end

                                                                                          print "\nUser that have location listed in 'twitter_data:'\n"
                                                                                          twitter_data.each do |user|
                                                                                            if user.values[0]["location"]
                                                                                              puts "#{user.keys.first}"
                                                                                            end
                                                                                          end
